...
const Card = ({ project }) => {
  ...
  const StarWrapper = styled.div`
    display: flex;
    background-color: ${project.pushLike
    ? props => props.theme.activeButtonColor
    : props => props.theme.unactivedColor};
    border-radius: 5px;
    height: 30px;
    align-items: center;
  `;
  ...
  const StarPath = styled.polygon`
    fill: ${project.pushLike
    ? props => props.theme.activeStarColor
    : props => props.theme.whiteColor};
  `;
