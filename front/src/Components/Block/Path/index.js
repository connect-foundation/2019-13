...
const path = {
  ...
  event: (width = 5) => `M 0,${CONSTANTS.PIXEL * 3} 
    c ${CONSTANTS.PIXEL * 6},-${CONSTANTS.PIXEL * 4} ${CONSTANTS.PIXEL * 14},-${CONSTANTS.PIXEL * 4} ${CONSTANTS.PIXEL * 20},0
    l 0,0 ${CONSTANTS.PIXEL * (width - 1)},0
    c ${CONSTANTS.PIXEL},0 ${CONSTANTS.PIXEL},0 ${CONSTANTS.PIXEL},${CONSTANTS.PIXEL}
    l 0,0 0,${CONSTANTS.PIXEL * 4}
    c 0,${CONSTANTS.PIXEL} 0,${CONSTANTS.PIXEL} -${CONSTANTS.PIXEL},${CONSTANTS.PIXEL}
    l 0,0 -${CONSTANTS.PIXEL * (width - 1 + 8)},0
    0,0 -${CONSTANTS.PIXEL * 2},${CONSTANTS.PIXEL * 2}
    0,0 -${CONSTANTS.PIXEL * 4},0 
    0,0 -${CONSTANTS.PIXEL * 2},-${CONSTANTS.PIXEL * 2}
    0,0 -${CONSTANTS.PIXEL * 3},0
    c -${CONSTANTS.PIXEL},0 -${CONSTANTS.PIXEL},0 -${CONSTANTS.PIXEL},-${CONSTANTS.PIXEL} 
    l 0,0 0,-${CONSTANTS.PIXEL * 5}`,
